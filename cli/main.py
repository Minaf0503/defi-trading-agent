...
app = typer.Typer(
    ...
    help="DeFi Trading Agents CLI: Multi-Agent LLM Framework for DeFi Trading",
...
class MessageBuffer:
    def __init__(self, max_length=100):
        ...
        self.agent_status = {
            ...
            "Tokenomics Analyst": "pending",
            "Sentiment/News Analyst": "pending",
            # Research Team
    ...
    def _update_current_report(self):
        ...
        if latest_section and latest_content:
            ...
            section_titles = {
                ...
                "onchain_report": "Onchain Analysis",
                "tokenomics_report": "Tokenomics Analysis",
                "sentiment_news_report": "Sentiment/News Analysis",
    ...
    def _update_final_report(self):
        ...
        if any(
            ...
            if self.report_sections["tokenomics_report"]:
                report_parts.append(
                    f"### Tokenomics Analysis\n{self.report_sections['tokenomics_report']}"
                )
            if self.report_sections["sentiment_news_report"]:
                report_parts.append(
                    f"### Sentiment/News Analysis\n{self.report_sections['sentiment_news_report']}"
                )
...
def update_display(layout, spinner_text=None):
    ...
    layout["header"].update(
        Panel(
            "[bold green]Welcome to DeFi Trading Agents CLI[/bold green]",
            title="Welcome to DeFi Trading Agents",
            border_style="green",
            padding=(1, 2),
            expand=True,
        )
...
def get_user_selections():
    ...
    welcome_content += "[bold green]DeFi Trading Agents: Multi-Agent LLM Framework for DeFi Trading - CLI[/bold green]\n\n"
    ...
    welcome_box = Panel(
        ...
        padding=(1, 2),
        title="Welcome to DeFi Trading Agents",
        subtitle="Multi-Agent LLM Framework for DeFi Trading",
    )
...
def display_complete_report(final_state):
    ...
    if final_state.get("tokenomics_report"):
        analyst_reports.append(
            Panel(
                Markdown(final_state["tokenomics_report"]),
    ...
    # Sentiment/News Analyst Report
    if final_state.get("sentiment_news_report"):
        analyst_reports.append(
            Panel(
                Markdown(final_state["sentiment_news_report"]),
    ...
    with Live(layout, refresh_per_second=4) as live:
        ...
        for chunk in graph.graph.stream(init_agent_state, **args):
            if len(chunk["messages"]) > 0:
                ...
                # Analyst Team Reports
                if "technical_report" in chunk and chunk["technical_report"]:
                    message_buffer.update_report_section(
                        "technical_report", chunk["technical_report"]
                    )
                    message_buffer.update_agent_status("Technical Analyst", "completed")
                    # Set next analyst to in_progress
                    if "onchain" in selections["analysts"]:
                        message_buffer.update_agent_status(
                            "Onchain Analyst", "in_progress"
                        )

                if "onchain_report" in chunk and chunk["onchain_report"]:
                    message_buffer.update_report_section(
                        "onchain_report", chunk["onchain_report"]
                    )
                    message_buffer.update_agent_status("Onchain Analyst", "completed")
                    # Set next analyst to in_progress
                    if "tokenomics" in selections["analysts"]:
                        message_buffer.update_agent_status(
                            "Tokenomics Analyst", "in_progress"
                        )

                if "tokenomics_report" in chunk and chunk["tokenomics_report"]:
                    message_buffer.update_report_section(
                        "tokenomics_report", chunk["tokenomics_report"]
                    )
                    message_buffer.update_agent_status("Tokenomics Analyst", "completed")
                    # Set next analyst to in_progress
                    if "sentiment_news" in selections["analysts"]:
                        message_buffer.update_agent_status(
                            "Sentiment/News Analyst", "in_progress"
                        )

                if "sentiment_news_report" in chunk and chunk["sentiment_news_report"]:
                    message_buffer.update_report_section(
                        "sentiment_news_report", chunk["sentiment_news_report"]
                    )
                    message_buffer.update_agent_status(
                        "Sentiment/News Analyst", "completed"
                    )
        ...
        if complete_report:
            ...
            with open(complete_report_file, "w") as f:
                f.write(f"# DeFi Trading Agents Complete Analysis Report\n")
