# DeFi Trading Agents/graph/setup.py
...
class GraphSetup:
    ...
    def setup_graph(
        self, selected_analysts=["technical", "onchain", "tokenomics", "sentiment_news"]
    ):
        ...
        Args:
            selected_analysts (list): List of analyst types to include. Options are:
                ...
                - "sentiment_news": Sentiment/News analyst
        """
        ...
        if "sentiment_news" in selected_analysts:
            analyst_nodes["sentiment_news"] = create_sentiment_news_analyst(
                self.quick_thinking_llm, self.toolkit
            )
            delete_nodes["sentiment_news"] = create_msg_delete()
            tool_nodes["sentiment_news"] = self.tool_nodes["sentiment_news"]
